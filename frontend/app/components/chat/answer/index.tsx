 ...
 */
  ...
  //   [{
  //     document_id: 1,
  //     document_name: "http://www.baidu.com",
  //     data_source_type: "web",
  //   },
  //   {
  //     document_id: 2,
  //     document_name: "http://www.example.com",
  //     data_source_type: "web",
  //   }
  //   ];
      ...
      <div className='flex items-start'>
        ...
        <div className={`${s.answerWrap}`}>
          <div className={`${s.answer} relative text-sm text-gray-900`}>
            <div className={`ml-2 px-4 bg-gray-100 rounded-tr-2xl rounded-b-2xl ${workflowProcess && 'min-w-[480px]'} ${citation?.length ? 'py-5' : 'py-3'}`}>
